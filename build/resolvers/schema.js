...
var _default = {
  User: {
    receivedFRequests: async (_parent, _args, {
      prisma,
      meId
    }) => {
    ...
    sentFRequests: async (_parent, _args, {
      prisma,
      meId
    }) => {
      // Does not throw errors if it doesn't find anything. Just returns [].
